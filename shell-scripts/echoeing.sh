...
| echo "PATH=$PATH:~/catkin_ws/src/octoROS/src:/home/henrivis/Documents/Codigos/rect2polar" >> ~/.bashrc \
...
| echo "alias gcpenv='source ~/Documents/Codigos/gcp-etl/.env'" >> ~/.bashrc
